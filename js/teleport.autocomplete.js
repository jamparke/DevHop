  ...
  })(
    {
      1: [
        function(_dereq_, module, exports) {
          ...
          var _coreJsLibraryFnObjectAssign = _dereq_(
            "core-js/library/fn/object/assign"
          );

          var _coreJsLibraryFnObjectAssign2 = _interopRequireDefault(
            _coreJsLibraryFnObjectAssign
          );

          var _coreJsLibraryFnArrayFind = _dereq_(
            "core-js/library/fn/array/find"
          );

          var _coreJsLibraryFnArrayFind2 = _interopRequireDefault(
            _coreJsLibraryFnArrayFind
          );

          var _coreJsLibraryFnRegexpEscape = _dereq_(
            "core-js/library/fn/regexp/escape"
          );

          var _coreJsLibraryFnRegexpEscape2 = _interopRequireDefault(
            _coreJsLibraryFnRegexpEscape
          );
 ...
 */
     ...
     */
            ...
            function TeleportAutocomplete() {
              ...
              var itemTemplate =
                _ref$itemTemplate === undefined
                  ? ITEM_TEMPLATE
                  : _ref$itemTemplate;
              var _ref$geoLocate = _ref.geoLocate;
              var geoLocate =
                _ref$geoLocate === undefined ? true : _ref$geoLocate;
              var _ref$apiRoot = _ref.apiRoot;
              var apiRoot =
                _ref$apiRoot === undefined
                  ? "https://api.teleport.org/api"
                  : _ref$apiRoot;
              var _ref$apiVersion = _ref.apiVersion;
              var apiVersion =
                _ref$apiVersion === undefined ? 1 : _ref$apiVersion;
              var _ref$embeds = _ref.embeds;
              var embeds =
                _ref$embeds === undefined
                ...
                },
                {
                  ...
                  value: function setupInput(el) {
                    ...
                    Object.defineProperty(this, "container", {
                      value: el.previousSibling
                    });
                    Object.defineProperty(this, "list", {
                      value: this.container.firstChild
                    });

                    var input = this.container.insertBefore(
     ...
     */
                ...
                },
                {
                  ...
                  value: function onkeydown(event) {
                    ...
                    // Prevent cursor move
                    if ([Key.UP, Key.DOWN].indexOf(code) !== -1)
                    ...
                    this.query
                      ...
                      .forEach(function(query) {
                        var matcher = new RegExp(
                          (0, _coreJsLibraryFnRegexpEscape2["default"])(query) +
                            "(?![^<]*>|[^<>]*</)",
                          "gi"
                        );
     ...
     */
                },
                {
                  ...
                  value: function getResultByTitle(title) {
                    ...
                    return (0, _coreJsLibraryFnArrayFind2["default"])(
                      this.results,
                      function(res) {
                  ...
                  value: function currentLocation() {
                    ...
                    navigator.geolocation.getCurrentPosition(
                      ...
                      function(_ref4) {
                        ...
                        setTimeout(function() {
                          return (_this5.el.placeholder =
                            _this5.oldPlaceholder);
                        }, 3000);
                      },
                      { timeout: 5000 }
                    );
     ...
     */
                },
                {
                  ...
                  value: function parseCity(res) {
                    var city =
                      res.embedded("location:nearest-city") ||
                      res.embedded("city:item");
                    city.country = city.embedded("city:country");
                    city.admin1_division = city.embedded(
                    ...
                    var title =
                      _res$matching_full_name === undefined
                        ? fullName
                        : _res$matching_full_name;
                    ...
                    if (city.country)
                      (0, _coreJsLibraryFnObjectAssign2["default"])(result, {
                        country: city.country.name
                      });
                    if (city.admin1_division) {
                      var _city$admin1_division = city.admin1_division;
                      var admin1Division = _city$admin1_division.name;
                      var admin1DivisionCode =
                        _city$admin1_division.geonames_admin1_code;

                      (0, _coreJsLibraryFnObjectAssign2["default"])(result, {
                        admin1Division: admin1Division,
                        admin1DivisionCode: admin1DivisionCode
                      });
                    }
                    ...
                    if (city.timezone) {
                      ...
                      (0, _coreJsLibraryFnObjectAssign2["default"])(result, {
                        tzOffsetMinutes: tzNow.total_offset_min
                      });
                    }
                  ...
                  value: function init(el) {
                    ...
                    var opt =
                      typeof el === "string" || el instanceof HTMLInputElement
                        ? (
                            0,
                            _coreJsLibraryFnObjectAssign2["default"]
                          )(options, { el: el })
                        : el;
 ...
 */
      ...
      3: [
        ...
        { "../../modules/$.core": 11, "../../modules/es6.array.find": 29 }
      ],
      4: [
        function(_dereq_, module, exports) {
        ...
        { "../../modules/$.core": 11, "../../modules/es6.object.assign": 30 }
      ],
      5: [
        function(_dereq_, module, exports) {
        ...
        { "../../modules/$.core": 11, "../../modules/es7.regexp.escape": 31 }
      ],
      6: [
        function(_dereq_, module, exports) {
          ...
          module.exports = function(TYPE) {
            ...
            return function($this, callbackfn, that) {
              var O = toObject($this),
                ...
                result = IS_MAP
                  ? asc($this, length)
                  : IS_FILTER ? asc($this, 0) : undefined,
                val,
                res;
      ...
      9: [
        ...
        { "./$.is-array": 18, "./$.is-object": 19, "./$.wks": 28 }
      ],
      10: [
        function(_dereq_, module, exports) {
      ...
      21: [
        ...
        { "./$": 20, "./$.fails": 15, "./$.iobject": 17, "./$.to-object": 26 }
      ],
      22: [
        function(_dereq_, module, exports) {
      ...
      37: [
        function(_dereq_, module, exports) {
          ...
          function _parse(unparsed, validation, path) {
            ...
            var allLinkArrays = parseLinks(
              unparsed._links,
              validation,
              path.push("_links")
            );
            var curies = parseCuries(allLinkArrays);
            var allEmbeddedArrays = parseEmbeddedResourcess(
              unparsed._embedded,
              validation,
              path.push("_embedded")
            );
          ...
          function parseLinks(links, validation, path) {
            ...
            if (links == null || links.self == null) {
              ...
              reportValidationIssue(
                "Resource does not have a self link",
                validation,
                path
              );
            }
 ...
 */
          ...
          function parseLink(linkKey, link, validation, path) {
            ...
            Object.keys(linkSpec).forEach(function(key) {
              if (copy[key] == null) {
                if (linkSpec[key].required) {
                  reportValidationIssue(
                    "Link misses required property " + key + ".",
                    validation,
                    path.push(linkKey)
                  );
                }
            ...
            if (copy.deprecation) {
              log(
                "Warning: Link " +
                  pathToString(path.push(linkKey)) +
                  " is deprecated, see " +
                  copy.deprecation
              );
            }
            ...
            if (copy.href && copy.href.indexOf("{") >= 0 && !copy.templated) {
              reportValidationIssue(
                "Link seems to be an URI template " +
                  'but its "templated" property is not set to true.',
                validation,
                path.push(linkKey)
              );
            }
        ...
        { "./immutable_stack": 36, "./resource": 38 }
      ],
      38: [
        function(_dereq_, module, exports) {
          "use strict";
          ...
          Resource.prototype._preResolveCurie = function(curie, rel) {
            ...
            if (curie.name === candidate) {
              if (curie.templated && prefixAndReference.length >= 1) {
                ...
                var href = curie.href.replace(
                  /(.*){(.*)}(.*)/,
                  "$1" + prefixAndReference[1] + "$3"
                );
          ...
          Resource.prototype.allEmbeddedArrays = Resource.prototype.allEmbeddedResources =
            Resource.prototype.allEmbeddedResourceArrays;
          Resource.prototype.embeddedArray =
            Resource.prototype.embeddedResourceArray;
      ...
      39: [
        function(_dereq_, module, exports) {
          module.exports = function(n) {
            var t = {},
              e = [];
            (n = n || this), (n.on = function(n, e, l) {
              (t[n] = t[n] || []).push([e, l]);
            }), (n.off = function(n, l) {
              n || (t = {});
              for (var o = t[n] || e, i = (o.length = l ? o.length : 0); i--; )
                l == o[i][0] && o.splice(i, 1);
            }), (n.emit = function(n) {
              for (
                var l,
                  o = t[n] || e,
                  i = o.length > 0 ? o.slice(0, o.length) : o,
                  c = 0;
                (l = i[c++]);
...
//# sourceMappingURL=teleport-autocomplete.js.
